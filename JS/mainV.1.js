...
function passInfo(elemento){
    ...
    for(let i=0;i < tablaPeriodica.elements.length;i++){
        if(tablaPeriodica.elements[i].symbol == elemento){
            atomicMass = tablaPeriodica.elements[i].atomic_mass
            catg = tablaPeriodica.elements[i].category
            state = tablaPeriodica.elements[i].phase
            ...
            document.getElementById("numAtom").innerText = tablaPeriodica.elements[i].number
            document.getElementById("massAtom").innerText = Math.round((atomicMass + Number.EPSILON) * 100) / 100;
            document.getElementById("nomElement").innerText = tablaPeriodica.elements[i].name
            document.getElementById("letters").innerText = tablaPeriodica.elements[i].symbol
            document.getElementById("summ").innerText = tablaPeriodica.elements[i].summary
        }
    }
}